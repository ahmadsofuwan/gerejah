<nav class="main-header navbar navbar-expand-md navbar-dark navbar-orange">
    <div class="container">
        <a href="assets/index3.html" class="navbar-brand">
            ...
            <h2><span class="brand-text font-weight-light"><strong><img src="<?= base_url('assets/logo.jpeg') ?>" alt="logo" class="rounded-circle p-1" style="width: 8%;"><?php echo ($this->db->where('nama', 'nama_aplikasi')->get('tentang')->row()->nilai) ?></strong></span></h2>
        </a>
        ...
        <div class="collapse navbar-collapse order-3 ml-lg-5" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="Welcome/login" class="nav-link">ADMIN</a>
                </li>
            </ul>
        </div>
    </div>
